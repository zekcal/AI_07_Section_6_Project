...
#### 5. 이 프로젝트를 진행하며 느낀 한계점은 다음과 같습니다.  
  ...
  6. 배포를 진행하지 못함  
    - 모델을 저장하고 불러오는 과정에서 오류가 발생해, 최초 기대한 수준으로 프로젝트를 완성하지 못함. 배포는 스스로 세운 '최소 기준 - 보통 기준 - 최고 기준' 중 최고 기준에 해당하긴 하지만, 그걸 감안하더라도 실제로 배포를 마치고 사람들의 반응을 확인해보고 싶었으나 그러지 못한 점이 아쉬움.
